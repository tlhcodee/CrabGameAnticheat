    ...
    public partial class Check
    {
        ...
        public void execution()
        {
            ...
            if (Plugin.choosenLanguage == Language.TURKISH)
            {
                ...
                ServerSend.SendChatMessage(1, $"Hile Kullanımı ({this.name} {this.level})");
            }
            else
            {
                ServerSend.SendChatMessage(1, "");
                ServerSend.SendChatMessage(1, $"[CAC] {this.player.name} is banned.");
                ServerSend.SendChatMessage(1, $"Cheating ({this.name} {this.level})");
            }
        }
